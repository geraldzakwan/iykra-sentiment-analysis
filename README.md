...
- Git
  ...
  You will use Git to access my code and to submit the assignment later.
  ...
  It will create `iykra-sentiment-analysis` directory, please remember this directory
